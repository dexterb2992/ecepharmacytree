                ...
                <table class="table table-bordered table-hover datatable">
                    ...
                    <tbody>
                        ...
                        <tr data-id="{{ $sale->id }}">
                            ...
                            <td>
                                <div class="tools">
                                 <a href="javascript:void(0);" class="add-edit-btn" data-action="edit" data-modal-target="#modal-view-member" data-title="Member Info" data-target="#form_view_member" data-id="{{ $sale->id }}" title="">
                                    <i class="fa fa-eye"></i> View
                                </a>
                                <br/>
                                <span class="action-icon marginleft-zero" data-action="unblock" data-title="member" data-urlmain="/members/" data-id="{{ $sale->id }}"><i class="fa fa-thumbs-o-up"></i> Unblock </span>
                                <span class="action-icon marginleft-zero" data-action="deactivate" data-title="member" data-urlmain="/members/" data-id="{{ $sale->id }}"><i class="fa fa-thumbs-o-down"></i> Block </span>
                            </div>
                        </td>
                    </tr>
                    @endforeach
