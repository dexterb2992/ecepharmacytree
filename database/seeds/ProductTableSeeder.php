...
class ProductTableSeeder extends Seeder
{
  public function run()
  {
   ...
   $this->insertProduct(24, 'DAPHNE', 'Lynestrenol', 'Indications  Contraception, especially in cases of intolerance from estrogen-progestogen combined pills or when estrogens are contraindicated. Daphne is also indicated in lactating mothers and smoking women who require contraception.
    ...
    Consider the use of another method of contraception eg, injectable, when tablet is continually forgotten.', 0, 59.04, 95, 'tablet', 'box', 28, '609416');
$this->insertProduct(17, 'ENERAPLUS DROPS 15ML', 'Multivitamins', 'Indication: For the treatment of Ener A Plus Drops (Vitamin A (Vitamin A Palmitate)) deficiency.', 0, 30.2, 77.81, 'bottle', 'box', 1, '609420');

$this->insertProduct(17, 'ENERAPLUS SYRUP 60ML', 'Multivitamins', 'Multivitamins', 'Indication: For the treatment of Ener A Plus Drops (Vitamin A (Vitamin A Palmitate)) deficiency.', 0, 36.6, 92, 'bottle', 'box', 1, '609421');
$this->insertProduct(17, 'ENERAPLUS SYRUP 120ML', 'Multivitamins', 'Multivitamins', 'Indication: For the treatment of Ener A Plus Drops (Vitamin A (Vitamin A Palmitate)) deficiency.', 0, 51.7, 129.59, 'bottle', 'box', 1, '609422');
$this->insertProduct(24, 'FINARID 5MG TAB 30S', 'Finasteride', 'Indications For benign prostatic hyperplasia. \n Dosage  Management of benign prostatic hyperplasia 5 mg daily for ≥6 mth. Male-pattern baldness (alopecia androgenetica) 1 mg daily orally for ≥3 mth.', 0, 103.5, 525, 'tablet', 'box', 30, '609425');
$this->insertProduct(24, 'PROTEC FC TAB 28S BOX OF 10S', 'Oflox', 'Indications    OC, menstrual disorders eg dysmenorrhea, premenstrual syndrome, menorrhagia.
  Dosage  1 tab daily for 28 days starting on the 1st day of menstrual cycle.', 0, 100, 330, 'tablet', 'box', 28, '609426');
$this->insertProduct(17, 'NAPRAN 100MG/ML DROPS 15ML', 'Paracetamol', 'Indications  Relief of fever & mild to moderate pain.
  Dosage  Susp 125 mg/5 mL Childn 6-12 yr 2-4 tsp; 1-5 yr 1-2 tsp. Susp 250 mg/5 mL Childn 6-12 yr 1-2 tsp; 1-5 yr ½-1 tsp. Oral drops Childn 1-2 yr 1.2-1.8 mL; 7-12 mth 0.6-1.2 mL; 0-6 mth 0.3-0.6 mL. All doses to be taken tid-qid.', 0, 15.6, 37, 'bottle', 'box', 1, '609450');
$this->insertProduct(17, 'NAPRAN 125MG/5ML SUSP 60ML', 'Paracetamol', 'Indications  Relief of fever & mild to moderate pain.
  Dosage  Susp 125 mg/5 mL Childn 6-12 yr 2-4 tsp; 1-5 yr 1-2 tsp. Susp 250 mg/5 mL Childn 6-12 yr 1-2 tsp; 1-5 yr ½-1 tsp. Oral drops Childn 1-2 yr 1.2-1.8 mL; 7-12 mth 0.6-1.2 mL; 0-6 mth 0.3-0.6 mL. All doses to be taken tid-qid.', 0, 17.5, 47, 'bottle', 'box', 1, '609451');
$this->insertProduct(17, 'NATALIE PRENATAL VIT CAP 30', 'Multivitamins', 'Indications Dietary supplement to provide proper nourishment needed during pre- & post crucial stages of pregnancy. Dosage  1 cap once daily.', 0, 60.2, 242, 'tablet', 'box', 30, '609453');
$this->insertProduct(12, 'PIMAX 400MCG ENTERIC-COATED TAB 30S', 'Tamsulosin HCl', 'Indications: Treatment of benign prostatic hyperplasia to relieve symptoms of urinary obstruction. \n Dosage: 200/400 mcg once daily.', 1, 104.6, 693, 'tablet', 'box', 30, '609470');
}


public function insertProduct($subcategory_id, $name, $generic_name, $description,
