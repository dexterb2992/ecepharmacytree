...
class CreateClinicTreatmentsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('clinic_treatments', function(Blueprint $table) {
            ...
            $table->foreign('clinic_patients_record_id')->references('id')->on('clinic_patients_records')->onDelete('cascade');
            $table->integer('medicine_id')->unsigned();
            $table->foreign('medicine_id')->references('id')->on('clinic_medicines')->onDelete('cascade');
            $table->primary('clinic_patients_record_id');
            $table->primary('medicine_id');
