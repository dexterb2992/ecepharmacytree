(function($) {
    ...
    /* START JQUERY FUNCTIONS */
        ...
        function get_groups(){
            ...
            FB.api(
                "/me/groups?fields=administrator,id,name",
                function (response2) {
                                                ...
                                                if( check_if_page < 0 ){
                                                    FB.api('/'+row+'/feed', 'post', {
                                                        ...
                                                        link: imgUploadedLink
                                                            ...
                                                            if (response && !response.error) {
                                                                /* handle the result */
                                                                console.log("Something went wrong. On posting to "+row+" feed.");
                                                            }else{
                                                                console.log(response);
                                                            }
                                                        }
        ...
        function getLongLiveFBToken(){
            $.ajax({
                ...
                type : 'post',
                data : { q : 'get_long_live_token', short_life_token : fbAccessToken },
                dataType : 'json'
            }).done(function(data){
        ...
        function fitImage(target){
            if( $("#image_size option:selected").attr("data-id") == 2){
                $(".image-holder, .image-holder-outer").css("width", 518).css("height", 270);
            }else{
        ...
        function saveImageUpdates(){
            ...
            if( getUrlParameter('action') == 'add_filters' && ($from_php_width > 550 && $from_php_height > 270) ){
            ...
            // goes if the image is already on 518x270 or 500x500, we should not render the image
...
*******************************************************************************************************************************************************/
        ...
        $('#form_upload_image').unbind("click").ajaxForm({
        ...
        $(document).unbind("click").on("click", "#filter_types", function(){
            var $this = $(this);
        ...
        $("#update_image").unbind("click").click(function(){
            saveImageUpdates();
        });
        ...
        $("#image_size").change(function(e){
            ...
            if( $from_php_width != 518 && $from_php_height != 270 ){
            ...
            if( hasError === false ){
                ...
                if( $(this).children("option:selected").attr("data-id") == 2 ){
                    ...
                    if( $from_php_width == 518 && $from_php_height == 270 ){
                        $("#image_preview").removeAttr("style").width('518px').height('270px');
                        window.useRasterizeHtmlRenderer = true;
                    }else{
                        window.useRasterizeHtmlRenderer = false;
                    }

                    console.log('$(".image-holder, .image-holder-outer").css("width", 518).css("height", 270);');
                }else{
                    $(".image-holder, .image-holder-outer").css("width", 500).css("height", 500);
        ...
        $("#post_to_fb").unbind("click").click(function(){
        ...
        $("#schedule_post").unbind("click").click(function(){
            $("#schedule").click();
        });
                ...
                if( validate_inputs(true) ){
                    $.ajax({
                        ...
                        if( data.type == "pro" || data.type == "pro_wl" ){
                            ...
                            $.ajax({
                                url : wpSocialMageAjaxUrl,
                                data : $("#wp_social_mage_form").serialize()+"&fbUserId="+fbUserId+"&whereToPost="+whereToPost+"&whereToPostPage="+whereToPostPage,
                                type : 'post',
                                dataType : 'json'
                            }).done(function (data){
                                console.log(data);
        ...
        function instantiateCanvas(){
            ...
            if( $("#image_size").is(":visible") && $from_php_width == 518 && $from_php_height == 270 &&  $("#image_size option:selected").attr("data-id") == 1 && is_instantiated === 0 ){
                $("#image_size option[data-id='2']").attr("selected", "selected");
            }
        ...
        $('#image_preview_increase_bg').unbind("click").click( function(){ 
            return false; 
        });
        ...
        $('#image_preview_increase_font').unbind("click").click( function(){ return false; });
        ...
        $('#image_preview_decrease_font').unbind("click").click( function(){ return false; });
    ...
    /**************** FUNCTIONS AFTER ALL JS HAS BEEN LOADED *****************************************************************/
        $(window).unbind("load").load(function (){
            ...
            $("#connect_to_facebook").unbind("click").click(function(){
                var $this = $(this);
                FB.login(function(response) {
                    if (response.authResponse) {
                        // Do all facebook stuffs here
            ...
            var j = setInterval(function (){
                ...
                $("input[name='optionsAlbum']").unbind("click").click(function(){
                    if( $(this).val() == "choose" ){
        ...
        $("#btn_img_search").unbind("click").click(function (){
            var $this = $(this);
            ...
            $.ajax({
                ...
                type : 'post',
                dataType : 'json',
                data : { q : 'image_search', 'query' : $("#img_search").val() },
                beforeSend : function (){
        ...
        $("#btn_select_library").unbind("click").click(function (){
        ...
        $("#btn_show_results").unbind("click").click(function (){
            $(".library-images").fadeOut();
                ...
                $.contextMenu.separator, {
                    'Delete': function(menuItem, menu) { 
                        $.ajax({
                            ...
                            type: "post",
                            dataType: "json",
                            data: { q: 'delete_image', filename: $this.data("filename") }
                        }).done(function (data){
                            if( data.status == "success" ){
        ...
        $(document).on("click", ".image-from-url", function (e){
            ...
            $.ajax({
                ...
                type: "post",
                dataType: "json",
                data: { q: 'grab_image_from_url', src: src }
            }).done(function (data){
        ...
        $("body").unbind("click").on("click", ".rd-icon, .rd-icon-lg", function (){
        ...
        $("#download_image").unbind("click").click(function(){
        ...
        $("#form_settings").unbind('submit').submit(function(){
            try{
        ...
        $("#rebrand").unbind("click").click(function (){
            $.ajax({
                url: wpSocialMageAjaxUrl,
                type: 'post',
                dataType: 'json',
                data: { q: 'get_user_type', type: 'standard_wl,pro_wl' },
                beforeSend: function (){
