		...
		try {
			...
			foreach($results as $result) {
				...
				if(count($results) == $counter) {
					...
					$this->emailtestingservice($email, $order_details, $recipient_name, $recipient_address, $recipient_contactNumber, $payment_method, $modeOfDelivery, $coupon_discount, $promo_discount, $totalAmount_final, $gross_total, $order_id, $order_details, $order_date, $status);
